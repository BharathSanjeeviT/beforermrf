      ...
      <div className="bg-[#fff] p-8 rounded shadow-lg relative rounded-lg">
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Input id="site-name" placeholder="Site Name" required
              value={name}
          ...
          <div className="space-y-2">
            ...
            <div className="py-3 flex flex-col gap-5">
              <div className="flex justify-center items-center">
                <Label className="mx-2" htmlFor="lat">Latitude</Label>
              ...
              <div className="flex justify-center items-center">
                <Label className="mx-2" htmlFor="lon">Longitute</Label>
                <Input id="lon" placeholder="longitude" required
                  value={lon}
                  onChange={(e) => setLon(e.target.value)}
                />
              </div>
              <div className="flex justify-center items-center">
                <Label className="mx-2" htmlFor="lon">Radius</Label>
                <Input id="lon" placeholder="radius" required
                  value={radius}
