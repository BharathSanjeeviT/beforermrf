          ...
          <div className="bg-card rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-5">
              <div className="my-3 mx-2 font-semibold flex items-center">
                ...
                <EditDate date={date} setDate={setDate} doTheHonours={getAttendence} />
              </div>
              <div>
                {fetching ?
                  <div>Loading...</div> :
                  attendence.length === 0 ? <div>No data found</div> :
                    <Table>
                      <TableHeader>
                        <TableRow>
                          ...
                          attendence.map((item, key) => {
                            return (
                              <TableRow key={key}>
                                ...
                                <TableCell>
                                  {parseInt(item.total_hours_worked) > 8 ? parseInt(item.total_hours_worked) - 8 : 0}
                                </TableCell>
                                <TableCell>
                                  {item.s_name}
                                </TableCell>
